...
`meta/FlareFtsoSubParserAuthoringMeta.rain.meta` and `meta/FlareFtsoWords.rain.meta` are generated outputs, not hand-edited. Run `./script/build.sh` to regenerate them and commit the result. If they drift, `git-clean` CI fails.
